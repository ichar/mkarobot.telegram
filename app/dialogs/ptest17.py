...
_RESULTS = {
    'ru' : {
        '01' : [(2, "Низкая степень агрессивности и высокая степень адаптированности по данному типу поведения"), (4, "Средняя степень агрессивности и адаптированности по данному типу поведения"), (8, "Высокая степень агрессивности и низкая степень адаптированности по данному типу поведения"), ],
        '02' : [(2, "Низкая степень агрессивности и высокая степень адаптированности по данному типу поведения"), (4, "Средняя степень агрессивности и адаптированности по данному типу поведения"), (8, "Высокая степень агрессивности и низкая степень адаптированности по данному типу поведения"), ],
        '03' : [(2, "Низкая степень агрессивности и высокая степень адаптированности по данному типу поведения"), (4, "Средняя степень агрессивности и адаптированности по данному типу поведения"), (8, "Высокая степень агрессивности и низкая степень адаптированности по данному типу поведения"), ],
        '04' : [(2, "Низкая степень агрессивности и высокая степень адаптированности по данному типу поведения"), (4, "Средняя степень агрессивности и адаптированности по данному типу поведения"), (8, "Высокая степень агрессивности и низкая степень адаптированности по данному типу поведения"), ],
        '05' : [(2, "Низкая степень агрессивности и высокая степень адаптированности по данному типу поведения"), (4, "Средняя степень агрессивности и адаптированности по данному типу поведения"), (8, "Высокая степень агрессивности и низкая степень адаптированности по данному типу поведения"), ],
    },
    'uk' : {
        '01' : [(2, "Низький ступінь агресивності й високий ступінь адаптованості за даним типом поведінки"), (4, "Середній ступінь агресивності й адаптованості за даним типом поведінки"), (8, "Високий ступінь агресивності й низький ступінь адаптованості за даним типом поведінки"), ],
        '02' : [(2, "Низький ступінь агресивності й високий ступінь адаптованості за даним типом поведінки"), (4, "Середній ступінь агресивності й адаптованості за даним типом поведінки"), (8, "Високий ступінь агресивності й низький ступінь адаптованості за даним типом поведінки"), ],
        '03' : [(2, "Низький ступінь агресивності й високий ступінь адаптованості за даним типом поведінки"), (4, "Середній ступінь агресивності й адаптованості за даним типом поведінки"), (8, "Високий ступінь агресивності й низький ступінь адаптованості за даним типом поведінки"), ],
        '04' : [(2, "Низький ступінь агресивності й високий ступінь адаптованості за даним типом поведінки"), (4, "Середній ступінь агресивності й адаптованості за даним типом поведінки"), (8, "Високий ступінь агресивності й низький ступінь адаптованості за даним типом поведінки"), ],
        '05' : [(2, "Низький ступінь агресивності й високий ступінь адаптованості за даним типом поведінки"), (4, "Середній ступінь агресивності й адаптованості за даним типом поведінки"), (8, "Високий ступінь агресивності й низький ступінь адаптованості за даним типом поведінки"), ],
    }
}

_CONCLUSIONS = {
    'ru' : {
        'F1' : ([(10, 'Обнаружена низкая степень агрессивности и высокая степень адаптированности поведения'), (24, 'Обнаружена средняя степень агрессивности и адаптированности поведения'), (40, 'Обнаружена высокая степень агрессивности и низкая степень адаптированности поведения')]),
    },
    'uk' : {
        'F1' : ([(10, 'Виявлено низький ступінь агресивності й високий ступінь адаптованості поведінки'), (24, 'Виявлено середній ступінь агресивності й адаптованості поведінки'), (40, 'Виявлено високий ступінь агресивності й низький ступінь адаптованості поведінки')]),
    },
}
...
def answer(bot, message, command, data=None, logger=None, question=None, **kw):
    ...
    if question > 191 and 'query_id' in kw:
    ...
    if is_run:
        ...
        for p in sorted([x for x in _PARAMS[lang].keys()]):
            if p in _results:
                ...
                storage.set(name, '%s.TP%s' % (_TEST_NAME, p), '%s:%s:%s' % (param, s1, value), with_encode=True)

        if not _is_without_conclusions:
            for conclusion in conclusions.keys():
                value, param = _results[conclusion]
                storage.set(name, '%s.RF' % _TEST_NAME, value)
                storage.set(name, '%s.T%s' % (_TEST_NAME, conclusion), '%s:%s' % (param, value), with_encode=True)
